...
class arDominionUenpPluginConfiguration extends sfPluginConfiguration
{
  public static
    $summary = 'Custom theme plugin made based in original Dominion Plugin theme. Cross-browser compatibility tested. Based in Twitter Bootstrap 2.0, 940px two-column layout, slightly responsive. <br>
Author: Rogério Matsui Guenta',
  ...
  public function contextLoadFactories(sfEvent $event)
  {
    ...
    if ($context->getConfiguration()->isDebug())
    {
      ...
      $context->response->addStylesheet('/plugins/arDominionUenpPlugin/css/main.less', 'last', array('rel' => 'stylesheet/less', 'type' => 'text/css', 'media' => 'all'));
    }
    else
    {
      $context->response->addStylesheet('/plugins/arDominionUenpPlugin/css/main.css', 'last', array('media' => 'all'));
    }
  }
